                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('posts.update',$post) }}" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            {{-- Retornar la ultima ariable guardada y si no traiga de la bd--}}
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="iframe" id="" class="form-control" value="{{ old('iframe', $post->iframe) }}"></textarea>
                        </div>
                        <div class="form-group">
                            @csrf
                            @method('PUT')
                            <input type="submit" value="ACTUALIAZR" class="btn btn-sm btn-success">
                        </div>
                    </form>
                </div>
            </div>
